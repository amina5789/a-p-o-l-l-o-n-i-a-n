...
<h4 onClick={()=>navigit(ROUTER_PATHS.gifts)}>GIFTS</h4>
...
<div className={styles.icons}>
  <img src={Icon2} alt="icon1"  className={styles.icon}/>
  <img src={Icon3} alt="icon2"  className={styles.icon}/>
  <img src={Icon4} alt="icon3" className={styles.icon} />
</div>
